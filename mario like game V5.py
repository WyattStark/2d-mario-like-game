...
def menu():
    ...
    while in_menu:
        ...
        dev_text = font.render("DEV TEST V5", True, BLACK)
...
def level_select():
    ...
    while in_select:
        ...
        dev_text = font.render("DEV TEST V5", True, WHITE)
        screen.blit(dev_text, (10, 10))
...
def level_complete(score, next_level):
    ...
    while in_complete:
        ...
        screen.blit(next_text, (next_button.x + next_button.width // 2 - next_text.get_width() // 2,
